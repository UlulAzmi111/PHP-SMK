    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-3 mt-4">
                <a href="index.php" style="text-decoration:none;"><h2>Admin Page</h2></a>
            </div>

            <div class="col-md-9">
                <div class="float-end mt-4 ml-4"><a href="?log=logout">logout</a></div>
                <div class="float-end m-4">User : <a href="?f=user&m=updateuser&id=<?php echo $_SESSION['iduser']?>"><?php echo $_SESSION['user'] ?></a></div>
                <div class="float-end mt-4 ml-4">LEVEL : <?php echo $_SESSION['level'] ?></div>
            </div>
        </div>
