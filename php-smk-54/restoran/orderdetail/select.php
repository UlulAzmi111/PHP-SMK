...
<div class="form-group">
    ...
    <div class="form-group w-50 float-start">
        ...
        <input type="date" name="tawal" required placeholder="isi kategori" class="form-control mt-2 mb-3">
    </div>

    <div class="form-group w-50 float-start">
        <label for="" class="ms-3">Tanggal Akhir</label>
        <input type="date" name="takhir" required placeholder="isi kategori" class="form-control mt-2 ms-3">
    </div>
