...
<div class="form-group">
    <form action="" method="post">
        ...
        <div class="form-group w-50">
            ...
            <input type="number" name="total" required value="<?php echo $row['total']?>" class="form-control mb-3">
        </div>

        <div class="form-group w-50">
            <label for="" class="mb-2">Bayar</label>
            <input type="number" name="bayar" required class="form-control">
        </div>

        <div>
            <input type="submit" name="simpan" value="Bayar" class="btn btn-primary mt-3 mb-3">
        </div>
