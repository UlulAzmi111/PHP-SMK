...
<body>
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="float-end mt-4 ml-4">Logout</div>
                <div class="float-end mt-4 ml-4 me-4">Login</div>
                <div class="float-end mt-4 ml-4 me-4">Pelanggan</div>
                <div class="float-end m-4">Daftar</div>
            </div>
        </div>
