    ...
    foreach ($_SESSION as $key => $value) {
        if ($key<>'pelanggan' && $key<>'idpelanggan') {
            ...
            foreach ($row as $r) {
                ...
                echo '<td>'.$r['menu'].'</td>';
                echo '<td>'.$r['harga'].'</td>';
                echo '<td><a href="?f=home&m=beli&tambah='.$r['idmenu'].'" style="text-decoration:none"> [+] </a> &nbsp &nbsp'.$value.'&nbsp &nbsp 
                      <a href="?f=home&m=beli&kurang='.$r['idmenu'].'" style="text-decoration:none"> [-] </a> </td>';
